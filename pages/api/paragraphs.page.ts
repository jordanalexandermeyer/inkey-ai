...
export default async function handler(request: NextRequest) {
  ...
  const prompts = args.map((arg, index) => {
    if (index == 0) {
      return `I. Topic Sentence\nA. \n\nII. Evidence and Analysis\nA. \nB. \nC. \nD. \n\nIII. Thesis Link\nA. \n\nYou are writing an essay in response to the prompt, "${prompt}". Your thesis is, "${thesis}". Using the above format, write an outline for a paragraph discussing the topic, "${arg}" that supports your thesis. In the "Topic Sentence" section, write a topic sentence. In the "Evidence and Analysis" section, write sentences that provide evidence supporting your topic sentence. Then, write sentences that explain how the evidence supports the topic sentence. In the "Thesis Link" section, write a sentence that ties back to the thesis statement. Use varied sentence structures and vocabulary. Refrain from using the same word or phrase more than once.\n\n`
    } else {
      return `I. Transition Sentence\nA. \n\nII. Evidence and Analysis\nA. \nB. \nC. \nD. \n\nIII. Thesis Link\nA. \n\nYou are writing an essay in response to the prompt, "${prompt}". Your thesis is, "${thesis}". The previous paragraph discussed, "${
        args[index - 1]
