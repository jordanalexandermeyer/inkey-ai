...
const CommonAppEssay: NextPage = () => {
  ...
  return (
    <ProtectedPage>
      <Head>
        <title>Common App Essay - Ghostwritten</title>
                ...
                <div className="sticky top-0 flex items-center px-6 py-4 bg-white border-b border-gray-200 z-10">
                  ...
                  <div>
                    ...
                    <p className="w-full text-sm text-gray-500">
                      Write some words and themes you want included in your
                      Common App essay and let the AI do the work!
                    </p>
                  </div>
                </div>
                <div className="p-3 xl:p-6 xl:pb-28 flex-1 space-y-6">
                  <TemplateTextArea
                    label="Words and Themes"
                    placeholder="growing up, childhood, biculturalism, cultural homelessness, dislocation, foreign, familiar, rootlessness, identity, confidence, empathy"
                    maxLength={500}
                    value={prompt}
                  ...
                  <button
                    ...
                    onClick={() =>
                      setPrompt(
                        'growing up, childhood, biculturalism, cultural homelessness, dislocation, foreign, familiar, rootlessness, identity, confidence, empathy',
                      )
                    }
                  >
