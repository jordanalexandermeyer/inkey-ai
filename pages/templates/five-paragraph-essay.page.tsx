...
const FiveParagraphEssayTemplate: NextPage = () => {
  ...
  const canSubmit = prompt && thesis && numberOfOutputs

  return (
    <ProtectedPage>
      <Head>
        <title>5 Paragraph Essay - Ghostwritten</title>
            ...
            <div className="overflow-y-auto xl:mb-0 xl:absolute xl:w-1/2 xl:inset-y-0 xl:left-0 xl:border-r xl:border-gray-200 bg-gray-50">
              <form className="flex flex-col h-full">
                <div className="sticky top-0 flex items-center px-6 py-4 bg-white border-b border-gray-200 z-10">
                  ...
                  <div>
                    ...
                    <p className="w-full text-sm text-gray-500">
                      Supply a prompt and thesis to create a compelling 5
                      paragraph essay.
                    </p>
                  </div>
                </div>
                <div className="p-3 xl:p-6 xl:pb-28 flex-1 space-y-6">
                  <TemplateInput
                    label="Prompt"
                    placeholder="What is the importance of investing money in space exploration?"
                    maxLength={100}
                    value={prompt}
                  ...
                  <TemplateTextArea
                    label="Thesis"
                    placeholder="Investing in space exploration will increase humanity's chance of survival, create a more prosperous society, and lead to a more harmonious world."
                    maxLength={250}
                    value={thesis}
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      setThesis(
                        "Investing in space exploration will increase humanity's chance of survival, create a more prosperous society, and lead to a more harmonious world.",
                      )
                    }}
                  >
